...
#
# Script generated by Vivado on Mon Jul 20 10:43:56 +0800 2026
...
# script info
echo -e "IROM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IROM xil_defaultlib.IROM xil_defaultlib.glbl -log elaborate.log
}
