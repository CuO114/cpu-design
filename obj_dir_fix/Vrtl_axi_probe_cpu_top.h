...
class alignas(VL_CACHE_LINE_BYTES) Vrtl_axi_probe_cpu_top final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__U_dcache__DOT__cache_we;
        ...
        CData/*0:0*/ __PVT__U_icache__DOT__cache_we;
    ...
    struct {
        ...
        IData/*31:0*/ __PVT__U_icache__DOT__req_addr_r;
        IData/*31:0*/ __Vdly__dc_cpu_raddr;
        VlWide<5>/*133:0*/ __Vdlyvval__U_icache__DOT__U_isram__DOT__mem__v0;
        QData/*63:0*/ __PVT__U_dcache__DOT__valid_lines;
        QData/*63:0*/ __PVT__U_icache__DOT__valid_lines;
        VlUnpacked<IData/*16:0*/, 64> __PVT__U_dcache__DOT__tag_hi;
        VlUnpacked<VlWide<5>/*133:0*/, 64> __PVT__U_dcache__DOT__U_dsram__DOT__mem;
        VlUnpacked<IData/*16:0*/, 64> __PVT__U_icache__DOT__tag_hi;
