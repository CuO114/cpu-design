...
VL_ATTR_COLD void Vrtl_axi_probe_cpu_top___ctor_var_reset(Vrtl_axi_probe_cpu_top* vlSelf) {
    ...
    vlSelf->__PVT__U_dcache__DOT__valid_lines = VL_RAND_RESET_Q(64);
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->__PVT__U_icache__DOT__tag_hi[__Vi0] = VL_RAND_RESET_I(17);
    }
    vlSelf->__PVT__U_icache__DOT__valid_lines = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__U_icache__DOT__req_addr_r = VL_RAND_RESET_I(32);
    ...
    vlSelf->__PVT__U_icache__DOT__cache_we = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
