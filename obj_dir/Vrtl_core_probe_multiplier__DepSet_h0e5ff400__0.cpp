...
VL_INLINE_OPT void Vrtl_core_probe_multiplier___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mul__0(Vrtl_core_probe_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vrtl_core_probe_multiplier___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mul__0\n"); );
    // Init
...
VL_INLINE_OPT void Vrtl_core_probe_multiplier___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mul__1(Vrtl_core_probe_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vrtl_core_probe_multiplier___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mul__1\n"); );
    // Body
