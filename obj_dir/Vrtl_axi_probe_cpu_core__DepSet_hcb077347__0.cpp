    ...
    if (vlSymsp->TOP__rtl_axi_probe.__PVT__rst) {
        ...
        if ((1U & (~ (IData)(vlSelf->__PVT__mem_stall)))) {
            ...
            if (((IData)(vlSelf->__PVT__mem_is_load) 
                ...
                vlSelf->__PVT__mem_wb_rdata = ((IData)(vlSymsp->TOP__rtl_axi_probe__dut.__PVT__U_dcache__DOT__hit_r)
                                                ? (
                                                   (0x85U 
                                                    >= 
                                                    (0xffU 
                                                     & VL_SHIFTL_III(8,32,32, 
                                                                     (3U 
                                                                      & (vlSymsp->TOP__rtl_axi_probe__dut.__PVT__U_dcache__DOT__current_addr 
                                                                         >> 2U)), 5U)))
                                                    ? 
                                                   (((0U 
                                                      == 
                                                      ...
                                                      ? 0U
                                                      : 
                                                     (vlSymsp->TOP__rtl_axi_probe__dut.__PVT__U_dcache__DOT__cache_line_r[
                                                      (((IData)(0x1fU) 
                                                        + 
                                                        (0xffU 
                                                         & VL_SHIFTL_III(8,32,32, 
                                                ...
                                                : (
                                                   ((3U 
                                                     == (IData)(vlSymsp->TOP__rtl_axi_probe__dut.__PVT__U_dcache__DOT__r_state)) 
                                                    & (IData)(vlSymsp->TOP__rtl_axi_probe__dut.__PVT__dc_dev_rvalid))
                                                    ? 
                                                   ((0xffffU 
                                                     == 
                                                     (vlSymsp->TOP__rtl_axi_probe__dut.__PVT__U_dcache__DOT__current_addr 
                                                      >> 0x10U))
                                                     ? 
                                                    vlSymsp->TOP__rtl_axi_probe__dut.__PVT__dc_dev_rdata[0U]
                                                     : 
                                                    (((0U 
                                                       == 
                                                       (0x1fU 
                                                       ...
                                                       ? 0U
                                                       : 
                                                      (vlSymsp->TOP__rtl_axi_probe__dut.__PVT__dc_dev_rdata[
                                                       (((IData)(0x1fU) 
                                                         + 
                                                         (0x7fU 
                                                          & VL_SHIFTL_III(7,32,32, 
