...
VL_ATTR_COLD void Vrtl_core_probe_multiplier__W21___stl_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mulu__0(Vrtl_core_probe_multiplier__W21* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vrtl_core_probe_multiplier__W21___stl_sequent__TOP__rtl_core_probe__dut__U_ALU__U_mulu__0\n"); );
    // Init
...
VL_ATTR_COLD void Vrtl_core_probe_multiplier__W21___ctor_var_reset(Vrtl_core_probe_multiplier__W21* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vrtl_core_probe_multiplier__W21___ctor_var_reset\n"); );
    // Body
