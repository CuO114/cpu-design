...
VL_INLINE_OPT void Vrtl_core_probe_ALU___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__0(Vrtl_core_probe_ALU* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_core_probe_ALU___ico_sequent__TOP__rtl_core_probe__dut__U_ALU__0\n"); );
    // Body
                          ...
                          ? ((8U & (IData)(vlSelf->op))
                              ? ((1U & (~ ((IData)(vlSelf->op) 
                                 ...
                                 && ((1U & (~ ((IData)(vlSelf->op) 
                                               >> 1U))) 
                                     && ((1U & (~ (IData)(vlSelf->op))) 
                                         && (vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a 
                                             >= vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b))))
                              : ((1U & ((IData)(vlSelf->op) 
                                        >> 2U)) && 
                                 ((1U & ((IData)(vlSelf->op) 
                                         >> 1U)) && 
                                  ((1U & (IData)(vlSelf->op)) 
                                   && VL_GTES_III(32, vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a, vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b)))))
                          : ((1U & ((IData)(vlSelf->op) 
                                    >> 3U)) && ((1U 
                                                 & (~ 
                                                    ((IData)(vlSelf->op) 
                                                ...
                                                && ((2U 
                                                    ...
                                                    ((1U 
                                                     ...
                                                     (vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a 
                                                      < vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b)
                                                      : 
                                                     VL_LTS_III(32, vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a, vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b))
                                                     : 
                                                    ((1U 
                                                      & (IData)(vlSelf->op))
                                                      ? 
                                                     ...
                                                     (vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a 
                                                      == vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b))))));
    vlSelf->mul_busy = vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mul.busy;
    ...
    vlSelf->__PVT__busy = ((IData)(vlSelf->mul_busy) 
                           | ((IData)(vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mulu.busy) 
    ...
    vlSelf->__PVT__effective_op = (((IData)(vlSelf->multi_active) 
                                    ...
                                    ? (IData)(vlSelf->op_r)
                                    : (IData)(vlSelf->op));
    vlSelf->__PVT__multi_start = ((~ (IData)(vlSymsp->TOP__rtl_core_probe__dut.__PVT__duplicate_mul)) 
    ...
    if ((0x10U & (IData)(vlSelf->__PVT__effective_op))) {
        if ((8U & (IData)(vlSelf->__PVT__effective_op))) {
            ...
            vlSelf->__PVT__c = ((1U & (IData)(vlSelf->__PVT__effective_op))
                                 ...
                                 : (((IData)(vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mulu.product_hi) 
                                     << 1U) | (1U & (IData)(
                                                            (vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mulu.product_lo 
                                                             >> 0x20U)))));
        } else if ((1U & (IData)(vlSelf->__PVT__effective_op))) {
            vlSelf->__PVT__c = (IData)(vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mul.product_hi);
            ...
            vlSelf->__PVT__c = vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mul.product_lo;
        }
    } else {
        vlSelf->__PVT__c = ((8U & (IData)(vlSelf->__PVT__effective_op))
                            ...
                            ((4U & (IData)(vlSelf->__PVT__effective_op))
                              ? ((2U & (IData)(vlSelf->__PVT__effective_op))
                                  ? ((1U & (IData)(vlSelf->__PVT__effective_op))
                                      ? VL_SHIFTRS_III(32,32,5, vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a, 
                                                       (0x1fU 
                                                        & vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b))
                                      : (vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a 
                                         >> (0x1fU 
    ...
    vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mul.start 
        = ((IData)(vlSelf->__PVT__multi_start) & (IData)(vlSelf->__PVT__mul_flag));
    vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mulu.start 
...
VL_INLINE_OPT void Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__0(Vrtl_core_probe_ALU* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__0\n"); );
    // Init
    ...
    vlSelf->__PVT__U_divu__DOT__start_d = ((1U & (~ (IData)(vlSymsp->TOP__rtl_core_probe.__PVT__rst))) 
                                           && (IData)(vlSelf->__Vcellinp__U_divu__start));
    vlSelf->__PVT__U_div__DOT__start_d = ((1U & (~ (IData)(vlSymsp->TOP__rtl_core_probe.__PVT__rst))) 
                                          && (IData)(vlSelf->__Vcellinp__U_div__start));
    if (vlSymsp->TOP__rtl_core_probe.__PVT__rst) {
        ...
        if (vlSelf->__PVT__U_divu__DOT__start_rise) {
            vlSelf->__PVT__U_divu__DOT__divisor = (QData)((IData)(vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b));
            __Vdly__U_divu__DOT__count = 0x21U;
            vlSelf->__PVT__U_divu__DOT__remainder = 0ULL;
            vlSelf->__PVT__U_divu__DOT__quotient = (QData)((IData)(vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a));
        ...
        if (vlSelf->__PVT__U_div__DOT__start_rise) {
            vlSelf->__PVT__U_div__DOT__divisor = ((vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b 
                                                   >> 0x1fU)
                                                   ? 
                                                  ((IData)(1U) 
                                                   + 
        ...
        if (vlSelf->__PVT__multi_start) {
            vlSelf->b_latched = vlSymsp->TOP__rtl_core_probe__dut.ex_alu_b;
            vlSelf->a_latched = vlSymsp->TOP__rtl_core_probe__dut.__PVT__ex_alu_a;
    ...
    vlSelf->__PVT__restart_continue = ((~ (IData)(vlSymsp->TOP__rtl_core_probe.__PVT__rst)) 
                                       & ((IData)(vlSelf->__PVT__any_mul_div) 
...
VL_INLINE_OPT void Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__1(Vrtl_core_probe_ALU* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__1\n"); );
    // Body
    vlSelf->mul_busy = vlSymsp->TOP__rtl_core_probe__dut__U_ALU__U_mul.busy;
    vlSelf->__PVT__mul_flag = ((0x10U == (IData)(vlSelf->op)) 
                               | (0x11U == (IData)(vlSelf->op)));
...
VL_INLINE_OPT void Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__2(Vrtl_core_probe_ALU* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_core_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_core_probe_ALU___nba_sequent__TOP__rtl_core_probe__dut__U_ALU__2\n"); );
    // Body
    vlSelf->__PVT__multi_start = ((~ (IData)(vlSymsp->TOP__rtl_core_probe__dut.__PVT__duplicate_mul)) 
                                  & (((~ (IData)(vlSelf->multi_active)) 
                                      & (IData)(vlSelf->__PVT__any_mul_div)) 
