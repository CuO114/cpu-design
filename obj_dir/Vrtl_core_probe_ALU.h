...
#ifndef VERILATED_VRTL_CORE_PROBE_ALU_H_
#define VERILATED_VRTL_CORE_PROBE_ALU_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
class Vrtl_core_probe_multiplier;
class Vrtl_core_probe_multiplier__W21;


class Vrtl_core_probe__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vrtl_core_probe_ALU final : public VerilatedModule {
  public:
    // CELLS
    Vrtl_core_probe_multiplier* U_mul;
    Vrtl_core_probe_multiplier__W21* U_mulu;
    ...
    // CONSTRUCTORS
    Vrtl_core_probe_ALU(Vrtl_core_probe__Syms* symsp, const char* v__name);
    ~Vrtl_core_probe_ALU();
    VL_UNCOPYABLE(Vrtl_core_probe_ALU);
