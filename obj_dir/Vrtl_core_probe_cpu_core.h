...
#ifndef VERILATED_VRTL_CORE_PROBE_CPU_CORE_H_
#define VERILATED_VRTL_CORE_PROBE_CPU_CORE_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
class Vrtl_core_probe_ALU;


class Vrtl_core_probe__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vrtl_core_probe_cpu_core final : public VerilatedModule {
  public:
    // CELLS
    Vrtl_core_probe_ALU* U_ALU;
    ...
    // CONSTRUCTORS
    Vrtl_core_probe_cpu_core(Vrtl_core_probe__Syms* symsp, const char* v__name);
    ~Vrtl_core_probe_cpu_core();
    VL_UNCOPYABLE(Vrtl_core_probe_cpu_core);
