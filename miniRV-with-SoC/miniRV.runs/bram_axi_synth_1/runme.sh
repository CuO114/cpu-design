...
HD_PWD='D:/cpu-design/miniRV-with-SoC/miniRV.runs/bram_axi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_axi.tcl
