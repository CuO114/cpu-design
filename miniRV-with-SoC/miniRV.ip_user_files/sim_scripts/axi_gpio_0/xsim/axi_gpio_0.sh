...
#
# Script generated by Vivado on Wed Jul 29 12:11:47 +0800 2026
...
# script info
echo -e "axi_gpio_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_gpio_0 xil_defaultlib.axi_gpio_0 xil_defaultlib.glbl -log elaborate.log
}
