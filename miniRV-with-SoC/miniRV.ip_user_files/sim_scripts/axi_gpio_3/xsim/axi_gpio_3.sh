...
#
# Script generated by Vivado on Wed Jul 29 12:11:54 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_gpio_3.sh
...
#
# Usage        : axi_gpio_3.sh
#                axi_gpio_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_gpio_3.sh [-reset_run]
#                axi_gpio_3.sh [-reset_log]
#                axi_gpio_3.sh [-help]
#
...
# script info
echo -e "axi_gpio_3.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_gpio_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_gpio_3 xil_defaultlib.axi_gpio_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_gpio_3 -key {Behavioral:sim_1:Functional:axi_gpio_3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_gpio_3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_gpio_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_gpio_3.sh [-help]\n\
Usage: axi_gpio_3.sh [-step]\n\
Usage: axi_gpio_3.sh [-lib_map_path]\n\
Usage: axi_gpio_3.sh [-reset_run]\n\
Usage: axi_gpio_3.sh [-reset_log]\n\
Usage: axi_gpio_3.sh [-keep_index]\n\
Usage: axi_gpio_3.sh [-noclean_files]\n\n\
