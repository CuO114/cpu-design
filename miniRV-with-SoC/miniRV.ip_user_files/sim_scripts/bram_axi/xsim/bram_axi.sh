...
#
# Script generated by Vivado on Wed Jul 29 12:25:56 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_axi.sh
...
#
# Usage        : bram_axi.sh
#                bram_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_axi.sh [-reset_run]
#                bram_axi.sh [-reset_log]
#                bram_axi.sh [-help]
#
...
# script info
echo -e "bram_axi.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_axi xil_defaultlib.bram_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_axi -key {Behavioral:sim_1:Functional:bram_axi} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_axi.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_axi.sh [-help]\n\
Usage: bram_axi.sh [-step]\n\
Usage: bram_axi.sh [-lib_map_path]\n\
Usage: bram_axi.sh [-reset_run]\n\
Usage: bram_axi.sh [-reset_log]\n\
Usage: bram_axi.sh [-keep_index]\n\
Usage: bram_axi.sh [-noclean_files]\n\n\
