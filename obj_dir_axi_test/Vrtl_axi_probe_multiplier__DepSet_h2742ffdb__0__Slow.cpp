...
VL_ATTR_COLD void Vrtl_axi_probe_multiplier___stl_sequent__TOP__rtl_axi_probe__dut__U_core__U_ALU__U_mul__0(Vrtl_axi_probe_multiplier* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_axi_probe_multiplier___stl_sequent__TOP__rtl_axi_probe__dut__U_core__U_ALU__U_mul__0\n"); );
    // Init
...
VL_ATTR_COLD void Vrtl_axi_probe_multiplier___ctor_var_reset(Vrtl_axi_probe_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtl_axi_probe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrtl_axi_probe_multiplier___ctor_var_reset\n"); );
    // Body
